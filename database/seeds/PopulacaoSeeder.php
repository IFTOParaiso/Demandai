...
class PopulacaoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Entities\Institution::create([ // ID:8 ARAGUATINS - TO
        ...
        \App\Entities\Institution::create([ // ID:9 Formoso do Araguaia - TO
        ...
        \App\Entities\Institution::create([ // ID:10 Lagoa da Confusão
        ...
        \App\Entities\Institution::create([ // ID:11 Pedro Afonso
        ...
        \App\Entities\Institution::create([ // ID:12 Reitoria
            'name' => 'IFTO - Reitoria',
        ...
        \App\Entities\User::create([
            ...
            'formation' => '1',
            'lattes' => 'http://lattes.cnpq.br/52059612',
            'status' => '1',
