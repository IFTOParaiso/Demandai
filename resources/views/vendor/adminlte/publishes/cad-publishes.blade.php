...
<div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
        ...
        @if(isset($publish))
            <form class="form-horizontal" method="post" action="{{ url('editar-edital/update', $publish->id) }}">
                {!! method_field('PUT') !!}
        @else
        ...
        <div class="tab-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('date_closure') ? 'has-error' : '' }}">
                        <input type="date" name="date_closure" class="form-control"
                               placeholder="Data de Encerramento" required="Informe a data de encerramento !">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('link') ? 'has-error' : '' }}">
                        ...
                        <button href="#tab_2" data-toggle="tab" class="btn btn-success pull-right">Próxima Etapa</button>
                </div>
            </div>
            ...
            <div class="tab-pane" id="tab_3">
                ...
                <button href="#tab_2" data-toggle="tab" class="btn btn-danger btn-flat pull-left">Voltar</button>
